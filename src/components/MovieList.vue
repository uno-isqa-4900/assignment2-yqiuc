      ...
      <div class="d-md-none" id="collapsable-card" style="width: 80%">
        <button type="button" class="btn btn-primary" @click="addNewMovie"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#0275d8"
            ...
            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-
                3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"/>
          </svg>
        </button>
                ...
                <button @click="deleteMovie(movie)" style="background-color: transparent; padding: 0;">
                  <svg @click="deleteMovie" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2
                        ...
                        4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-
                        7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                  </svg></button>
              </div>
            </div>
          </div>
